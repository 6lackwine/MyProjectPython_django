...
from .views import ShopIndexView, \
    ...
    OrderExport, \
    ProductViewSet, \
    OrderViewSet, LatestProductsFeed, UserOrdersListView, UserOrdersDataExportJSON
...
urlpatterns = [
    ...
    path("users/<int:user_id>/orders/export/", UserOrdersDataExportJSON.as_view(), name="user_orders_export"),
]
